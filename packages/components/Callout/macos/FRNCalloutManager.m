...
// RCTConvert does not properly convert a JS screenRect into a native
// CGRect/NSRect, due to the mismatch of x/y and screenX/screenY. Let's do it
// manually. Note this does not take into account that macOS uses a flipped Y
// axis.
