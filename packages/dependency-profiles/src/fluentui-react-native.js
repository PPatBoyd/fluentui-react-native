...
/* eslint-disable */
module.exports = {
  'fluentui/react-native/all': {
    name: '#meta',
    // capabilities: ['fluentui/react-native/components', 'fluentui/react-native/theming', 'uifabricshared/all'],
  },
  'uifabricshared/all': {
    name: '#meta',
    capabilities: [
  ...
  '@fluentui-react-native/menu-button': {
    ...
    version: '0.0.0',
    capabilities: ['@fluentui-react-native/menu'],
  },
